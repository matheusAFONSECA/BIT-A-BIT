...
import 'mapa3passo.dart';

// ignore: must_be_immutable
class Mapa3Simp extends StatefulWidget {
  String expressao;
  Mapa3Simp(this.expressao, {super.key});

  @override
  _Mapa3Simp createState() => _Mapa3Simp();
}

class _Mapa3Simp extends State<Mapa3Simp> {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextButton(
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => Mapa3Passo(expressao)));
                          },
